...
const useBroadcastChannel = (channelName, options = {}) => {
    const { sourceName, cleaningInterval = 1000, keepLatestMessage = false, registeredTypes = [], namespace = '', } = options;
    ...
    const clearMessage = (id) => {
        ...
        (_a = channel.current) === null || _a === void 0 ? void 0 : _a.postMessage({ id, type: '__CLEAR_MESSAGE__', source });
    };
    const clearAllMessages = () => {
        var _a;
        setMessages([]);
        setSentMessages([]); // Clear all sent messages
        (_a = channel.current) === null || _a === void 0 ? void 0 : _a.postMessage({ id: '__CLEAR_ALL_MESSAGES__', type: '__CLEAR_ALL_MESSAGES__', source });
    };
...
function BroadcastProvider({ children }) {
    ...
    return (jsx(BroadcastContext.Provider, { value: { messages, postMessage, error }, children: children }));
}
