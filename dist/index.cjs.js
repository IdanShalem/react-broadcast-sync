...
const useBroadcastChannel = (channelName, options = {}) => {
  ...
  const receivedMessageIds = react.useRef(new Set());
  const source = react.useRef(sourceName || generateSourceName()).current;
...
const BroadcastContext = /*#__PURE__*/react.createContext(null);
function BroadcastProvider({
  ...
  return jsxRuntime.jsx(BroadcastContext.Provider, {
    value: {
      messages,
      postMessage,
      error
